      ...
      <Container className="mt-24 sm:mt-32 md:mt-56">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-neutral-600">
            We specialize in crafting efficient, high quality web applications
            for businesses hoping to establish or expand their business online.
            From planning to production, we work with you every step of the way
